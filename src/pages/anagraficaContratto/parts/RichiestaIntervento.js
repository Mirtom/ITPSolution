...
const RichiestaIntervento = ({flag,handleClose,type,data,richiesta,handleReload}) => {
    ...
    //Call API webservice
    const { getUserList, userList, createIntervento,createInfoBox } = webservice()
    ...
    return (
        ...
        {type === 'man' ? (
            <Dialog open={flag} fullWidth={true} maxWidth={'lg'} onClose={handleClose} aria-labelledby="form-dialog-title">
                    <DialogTitle id="form-dialog-title"><Typography variant='h5'>Richiesta di Manutenzione</Typography></DialogTitle>
                    <DialogContent>
                        <Box style={{display:'flex',alignItems:'center'}}>
                            <Typography variant="subtitle1" className={classes.helperTopText}>NB: Manutenzione Contratto</Typography>
                            <Typography variant='subtitle1' style={{fontWeight:'normal',marginLeft:5}}>{ data.titolo + ' ' + data.id}</Typography>
                        </Box>
                        <Box className={classes.mainTab}>
                            <Box className={classes.mainRow} >
                                ...
                                <Box className={classes.mainColumn}>
                                    <Typography variant='subtitle1' className={classes.columnLabel} >* Inizio Manutenzione</Typography>
                                    <TextField
                                ...
                                <Box className={classes.mainColumn}>
                                    <Typography variant='subtitle1' className={classes.columnLabel} >Fine Manutenzione</Typography>
                                    <TextField
                            ...
                            <Box className={classes.mainRow}>
                                ...
                                <Box className={classes.mainColumn} style={{width:'25%'}}>
                                    ...
                                    <Typography variant='caption' style={{color:'#0000008a'}}>Definisci le notifiche di arrivo</Typography>
                                    <Box>
                                        <FormControlLabel
                                            className={classes.controlLabel}
                                            control={
                            ...
                            <Box className={classes.mainRow}>
                                ...
                                {/*<Box className={classes.mainColumn} style={{width:'20%'}}>
                                    ...
                                    <Autocomplete
                                        ...
                                        id="combo-box-demo"
                                        options={userList !== undefined ? userList.filter(e => e.Tipologia === 'Utente') : userList}
                            ...
                            <Box style={{display:'flex',justifyContent:'center',padding:'10px 100px 0'}}>
                                ...
                                onClick={async e=> {
                                    let infoUp={
                                        ...
                                        descrizione:richiestaData.descrizione,
                                        byAsset:data.id,
                                        intestazione:'Richiesta Intervento'
                                    }
                                    await createInfoBox(infoUp)
                                    var toUp = {
                                        token: getUserData().Token,
